...
} from "../SchedulingForm/schedulingSchemas";
import styles from "./scheduling-form.module.css";
import { ErrorMessage } from "../../../../shared/components/ErrorMessage";
import { LoadingSpinner } from "../../../../shared/components/LoadingSpinner";

interface ISchedulingFormEdit {
  onClose: () => void;
  initialData?: Partial<SchedulingEditFormData>;
  studentId: string;
}

export const SchedulingFormEdit: React.FC<ISchedulingFormEdit> = ({
  onClose,
  initialData,
  studentId,
}) => {
  ...
  } = useForm<SchedulingEditFormData>({
  ...
  const onSubmit = async (data: SchedulingEditFormData) => {
    setIsSubmitting(true);
    setSubmitError(null);
    setSubmitSuccess(false);

    try {
      const url = `${import.meta.env.VITE_API_URL}/scheduling/${studentId}`;
      const method = "PATCH";
  ...
  return (
    ...
    >
      <div className={styles.container}>
        ...
        {submitSuccess && (
          <div>{`Agendamento ${"atualizado"} com sucesso!`}</div>
        )}
